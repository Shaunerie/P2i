...
def voisinage(i, POSITION, GRILLE, c, indice_temps):
    ...
    voisinage = []
    try:
        voisinage =  GRILLE[int(POSITION[indice_temps,i,0]/c), int(POSITION[indice_temps,i,1]/c)]
    except:
        print("erreur")
        print("position x: ", POSITION[indice_temps,i,0])
        print("position y: ", POSITION[indice_temps,i,1])
        print("indice x: ", int(POSITION[indice_temps,i,0]/c))
        print("indice y: ", int(POSITION[indice_temps,i,1]/c))

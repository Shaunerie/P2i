...
@njit(fastmath=True)
def resultante_et_actualisation_2(POSITION, VITESSE, ACCELERATION, VITESSE_DEMI_PAS, GRILLE, nb_grains, indice_temps, pas_de_temps, c, rayon, masse, Agauche, Cgauche, Adroite, Cdroite, largeur_silo_gauche):
    """
    ...
    for grain1 in range(nb_grains):
        ...
        if penetration_gauche < 0:
            ...
            if penetration_bac < 0:
                force_resultante += -raideur_bac * penetration_bac * np.array([0,1])
    ...
    return force_resultante, ACCELERATION, VITESSE_DEMI_PAS
...
masse = 1e-3 #kg    
rayon = 1e-2 #m
raideur_normale = 500 #N/m
raideur_tangentielle = 50 #N/m
coefficient_de_frottement = 0.05 #N/m(air)
...
if __name__ == "__main__":
    ...
    for indice_temps in tqdm(range(1, nb_temps)):
        ...
        force_resultante, ACCELERATION, VITESSE_DEMI_PAS = resultante_et_actualisation_2(POSITION, VITESSE, ACCELERATION, VITESSE_DEMI_PAS, GRILLE, nb_grains, indice_temps, pas_de_temps, c, rayon, masse, Agauche, Cgauche, Adroite, Cdroite, largeur_silo_gauche)

...
def grain_anime(POSITION, nb_grains, RAYON, Agauche, Cgauche, Adroite, Cdroite, paroiGauche, paroiDroite, debut_du_trou, hauteur_bac, largeur_bac_gauche, largeur_bac_droite, limite_gauche, limite_droite, pas_de_temps, nb_temps):
    """
...
MASSE = rho * 4/3 * pi * RAYON**2

# Définition du milieu 
raideur_normale = rho*10 #N/m
raideur_tangentielle = (1/2)*raideur_normale #N/m
coefficient_trainee = 1000
...
temps = 0
indice_temps = 0
pas_de_temps = (1/raideur_normale)*10 #s
duree_simulation = 3 #s
...
if __name__ == "__main__":
    ...
    grain_anime(POSITION, nb_grains, RAYON, Agauche, Cgauche, Adroite, Cdroite, paroiGauche, paroiDroite, debut_du_trou, hauteur_bac, largeur_bac_gauche, largeur_bac_droite, limite_gauche, limite_droite, pas_de_temps, nb_temps)